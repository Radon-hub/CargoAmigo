...
import org.radon.userservice.common.errorHandling.RestAccessDeniedHandler
import org.radon.userservice.common.errorHandling.RestAuthenticationEntryPoint
...
open class AuthConfig(
    ...
    @Order(1)
    @Throws(Exception::class)
    open fun publicChain(http: HttpSecurity): SecurityFilterChain? {
        http
            .csrf{ it.disable() }
